...
Average NED (Normalized Ensemble Defect)

0.043

Average PD (Probability Defect)
...
Enable parallel processing (multiprocessing).

False

--repeat

Number of times to repeat the experiment (runs).

1

--worker_count

Number of CPU workers for parallel mode.

10

--nosm

Disable structured mutation (revert to random/traditional mutation).

False

--nomfe

Skip MFE (Minimum Free Energy) check (faster, less accurate).
...
https://github.com/shanry/SAMFEO
